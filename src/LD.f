...
! ET is the total potential and kinetic energy 
      ...
      dimension DumE(11), Res(AN), count(NC)
      real RsBy
...
! these routines compute the forces
      ...
      if (isdbGaussian_Dihed .eq. 'YES') then
        call dbG_dihedral(DumE(11))
      endif
      ...
      call contacts(DumE(4), DumE(10), Conts, count, outE)
...
! calculate electrostatic force
     ...
     Q    DumE(5) + DumE(6) + DumE(7) + DumE(8) + DumE(9) + DumE(10) + DumE(11)
        if(EnergyTerm .ne. 'NO')then
      write(70,"(11F9.2)") DumE(1),DumE(2),DumE(3),DumE(4),DumE(5),
     Q DumE(6),DumE(7),DumE(8), DumE(9), DumE(10), DumE(11)
	endif
      endif
